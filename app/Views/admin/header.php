    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">PENILAIAN SPBE</div>
            ...
            <li class="nav-item">
                ...
                <span style="color: white;">Admin SPBE </span></a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?php echo site_url('admin/v_dashboard')?>">
            ...
            <li class="nav-item">
                ...
                <span style="color: white;">Pengguna</span></a>
            </li>
            ...
            <li class="nav-item active">
                ...
                <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?php echo site_url('admin/dokumen_peraturan')?>">Dokumen </a>
                        <a class="collapse-item" href="<?php echo site_url('admin/tambah_dokumen')?>">Create</a>
                    </div>
                </div>
            </li>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-800 ">nAMA <?php echo session()->get('akun_username')?></span>
